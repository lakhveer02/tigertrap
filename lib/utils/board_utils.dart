...
class BoardUtils {
  static BoardConfig getAaduPuliConfig() {
    ...
    final connections = [...horizontalConnections, ...verticalConnections];
  ...
  static Offset _getPositionForIndex(int index) {
    switch (index) {
      ...
      case 1:
        return Offset(0.0, 0.21);
      case 2:
        return Offset(0.35, 0.21);
      case 3:
        return Offset(0.45, 0.21);
      case 4:
        return Offset(0.55, 0.21);
      case 5:
        return Offset(0.65, 0.21);
      case 6:
        return Offset(1.0, 0.21);
      case 7:
        return Offset(0.0, 0.45);
      case 8:
        return Offset(0.235, 0.45);
      case 9:
        return Offset(0.4, 0.45);
      case 10:
        return Offset(0.6, 0.45);
      case 11:
        return Offset(0.77, 0.45);
      case 12:
        return Offset(1.0, 0.45);
      case 13:
        return Offset(0.0, 0.7);
      case 14:
        return Offset(0.135, 0.7);
      case 15:
        return Offset(0.35, 0.7);
      case 16:
        return Offset(0.64, 0.7);
      case 17:
        return Offset(0.86, 0.7);
      case 18:
        return Offset(1.0, 0.7);
      case 19:
        return Offset(0.04, 1);
      case 20:
        return Offset(0.3, 1);
      case 21:
        return Offset(0.68, 1);
      case 22:
        return Offset(0.95, 1);
      default:
        return Offset(0, 0);
    }
  }
    ...
    for (final node in nodes) {
      for (final adjacent in node.adjacentPoints) {
        ...
        if (!addedPairs.contains(pairKey) &&
            !addedPairs.contains(reversePairKey)) {
